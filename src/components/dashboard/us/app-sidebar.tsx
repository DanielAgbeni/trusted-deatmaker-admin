                  ...
                  {profileData?.data && (
                    <div className="space-y-3 border-t border-gray-100 pt-3">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-600">{profileData.data.phoneNumber}</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <Shield size={14} className="text-gray-400" />
                        <span className="text-gray-600">
                          KYC: <span className="font-medium">{profileData.data.kycStatus === true ? "true" : "Pending"}</span>
                        </span>
                      </div>
                    </div>
                  )}
